...
def read_sequences(file_path1, file_path2):
...
if __name__ == "__main__":
    if len(sys.argv) != 3:
        print("Usage: python script.py <sequence_file1> <sequence_file2>")
        sys.exit(1)

    sequence1, sequence2 = read_sequences(sys.argv[1], sys.argv[2])

    alignment1, alignment2, score = needleman(sequence1, sequence2)
